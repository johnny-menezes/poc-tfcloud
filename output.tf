...
output "arn" {
  description = "AWS SecretManager Secret ARN"
  value       = module.asm_gopoints.arn.arn
}

output "id" {
  description = "AWS SecretManager Secret ARN"
  value       = module.asm_gopoints.id.id
}

output "secret" {
  description = "AWS SecretManager Secret resource"
  value       = module.asm_gopoints.secret.secret_demo
}

output "secret_version" {
  description = "AWS SecretManager Secret Version resource"
  value       = module.asm_gopoints.secret_version.secret_demo
  sensitive   = true
}